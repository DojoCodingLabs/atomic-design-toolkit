...
project-name: dojo-os                        # from package.json "name" or pubspec.yaml "name"
...
design-system: dojo-ds                       # label; "custom" if no standard DS detected
...
project-name: dojo-os
project-version: 1.4.5
stack: vite
framework: react
package-manager: bun
design-system: dojo-ds
...
- **Remediation:** Add a `structural-guard` step to `lint.yml` (analog of `primitives-guard.ts` in DOJ-3698). Fail builds on violations.
- **Blocks:** (none)
- **Blocked by:** E4
