...
Bundle-health and component-inventory checks (V1-V5) tell you *what is broken today*. They do not tell you whether the project will **drift again tomorrow**. V7 measures the four-cure defense-in-depth pattern (premortem reference: DOJ-3946 component-layer Conway's Law, dojo-os 2026-05-14, $394K already spent + $324K forward extrapolation if unaddressed). Read the full setup walkthrough at `${CLAUDE_PLUGIN_ROOT}/references/atomic-design-hooks-setup.md`.
